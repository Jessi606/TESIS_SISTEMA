...
<head>
    ...
    <style>
        ...
        .container {
            max-width: 2000px; /* Reducir el ancho del contenedor principal */
        ...
        .alert {
            margin-top: 20px;
            margin-bottom: 0; /* Evitar que los mensajes de alerta tengan margen inferior */
        }
    </style>
</head>
<body>
    <div class="container">
        <h1 class="mt-5">Registro de Auditoría</h1>
        ...
        <a href="tarea.php" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Volver a las Tareas</a>
    </div>
