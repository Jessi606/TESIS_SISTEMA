...
<div class="container">
    ...
    <?php if (isset($_GET['success']) && $_GET['success'] == 1): ?>
        ...
        <?php elseif (isset($_GET['action']) && $_GET['action'] == 'anular'): ?>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if ($estado == 'activo') {
                    echo "<a href='editar_cliente.php?id={$row['Idcliente']}' class='btn btn-warning btn-sm'><i class='fas fa-edit'></i> Editar</a>
                          <a href='anular_cliente.php?id={$row['Idcliente']}&action=anular' class='btn btn-danger btn-sm' onclick='return confirm(\"¿Estás seguro de que deseas anular este cliente?\");'><i class='fas fa-ban'></i> Anular</a>";
                } else {
