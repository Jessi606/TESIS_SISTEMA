    <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            registrarAuditoriaProyecto($con, $idProyecto, $accion, $detalles, $idUsuario);
        ...
        $sql = "SELECT ap.IdAuditoriaProy, ap.Idproyecto, ap.Accion, ap.Detalles, ap.FechaHora, u.Nombre as NombreUsuario 
