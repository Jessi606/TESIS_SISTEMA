...
<head>
    ...
    <title>Informe de Requerimientos de Auditoría</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="title">Informe de Requerimientos de Auditoría</div>
        </div>
    ...
    if ($result->num_rows > 0) {
        while ($row_data = $result->fetch_assoc()) {
            echo "<tr>";
            echo "<td>" . htmlspecialchars($row_data['Idrequerimiento']) . "</td>";
            echo "<td>" . htmlspecialchars($row_data['Titulo']) . "</td>";
            echo "<td>" . htmlspecialchars($row_data['Descripcion']) . "</td>";
            echo "<td>" . htmlspecialchars($row_data['Solicitante']) . "</td>";
            echo "<td>" . $row_data['Fecha_creacion'] . "</td>";
            echo "<td>" . $row_data['Fecha_vencimiento'] . "</td>";
            echo "<td>" . $row_data['Estado_requerimiento'] . "</td>";
            echo "<td>" . htmlspecialchars($row_data['Remitente']) . "</td>";
            echo "<td>" . htmlspecialchars($row_data['Comentario']) . "</td>";
            echo "</tr>";
        }
    } else {
        echo '<tr><td colspan="9">No hay requerimientos registrados.</td></tr>';
    }
    ...
    <script>
        function exportToPDF() {
            ...
            doc.setFontSize(18);
            doc.text("Informe de Requerimientos de Auditoría", doc.internal.pageSize.getWidth() / 2, 35, { align: 'center' });
            ...
            const options = {
                ...
                columnStyles: {
                    ...
                    1: { cellWidth: 20 }, // Título
                    2: { cellWidth: 20 }, // Descripción
                    3: { cellWidth: 20 }, // Solicitante
                    4: { cellWidth: 20 }, // Fecha de Creación
                    5: { cellWidth: 20 }, // Fecha de Vencimiento
                    6: { cellWidth: 20 }, // Estado
                    7: { cellWidth: 20 }, // Remitente
                    8: { cellWidth: 20 }  // Comentario
                }
            };
            ...
            doc.save('requerimientos_auditoria.pdf');
        }
        ...
        function exportToExcel() {
            ...
            XLSX.writeFile(workbook, 'requerimientos_auditoria.xlsx');
        }
    </script>
</body>
</html>
